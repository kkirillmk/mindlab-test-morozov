...
return [
    ...
    'description' => 'API для управления пользователями и ролями с JWT аутентификацией.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Для получения токена доступа используйте endpoint `/api/v1/auth/login`. После успешного входа вы получите `access_token` и `refresh_token`. Используйте `access_token` в заголовке `Authorization: Bearer {access_token}` для доступа к защищённым эндпоинтам.',
    ],
